...
b = {
    "set builder notation my version":
    "assumes that there is a set if condition A, then condition B. if condition B, then condtion A. Both A and B are assumptions about the subset relations."
}
def main():
    print(a["set builder notation "])
